...
public interface ITerminalService
{
    ...
    /// <param name="workingDirectory">Optional working directory for the command execution.</param>
    /// <param name="cancellationToken"></param>
    /// <returns>A TerminalResult object containing the output and status of the command.</returns>
    Task<TerminalResult> ExecuteCommandAsync(string command, string? workingDirectory = null, CancellationToken cancellationToken = default);
}